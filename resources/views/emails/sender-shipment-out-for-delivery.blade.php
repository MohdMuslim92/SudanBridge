...
<div style="padding: 20px;">
    <h1 style="text-align: center;">Shipment Out for Delivery</h1>
    <p>Dear <strong>{{ $shipment->sender->name }}</strong>,</p>
    <p>Your shipment <strong>{{ $shipment->item->name }}</strong> is now out for delivery to {{ $shipment->recipient->name }}'s address.</p>
    <p>Here are the details:</p>
    <ul>
        <li><strong>Recipient Address:</strong> {{ $shipment->recipient->address->state }}, {{ $shipment->recipient->address->city }}, {{ $shipment->recipient->address->street }}, {{ $shipment->recipient->address->details }}</li>
