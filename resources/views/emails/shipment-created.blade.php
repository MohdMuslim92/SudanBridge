...
<div style="padding: 20px;">
    ...
    <p>Your shipment <strong>{{ $shipment->item->name }}</strong> has been successfully created. Here are the details:</p>
    <ul>
        <li><strong>Recipient Name:</strong> {{ $shipment->recipient->name }}</li>
